...
import { applyHint, applyInput, clearCell, createGameState, deserializeGameState, getConflictingCells, getPeerIndexes, isSolved, parseGrid, serializeGameState, toggleNoteMode } from "./index.js";
const puzzle = {
    puzzleId: "easy-001",
...
describe("domain helpers", () => {
    ...
    it("detects solved boards", () => {
        const solved = parseGrid("534678912672195348198342567859761423426853791713924856961537284287419635345286179");
