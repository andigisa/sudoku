 ...
 */
export function upgradeGuestToUser(guestId: string, userId: string): void {
  const tables = [gameSessions, tournamentEntries, leaderboardSnapshots, abuseFlags] as const;
